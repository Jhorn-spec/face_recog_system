from face_recog_app.helpers import backends, detector, models, df_metrics, delete_representations, get_id
import cv2
...
def face_detect(image_path):
    ...
    if face is not None:
        ...
        try:
            file_path=None
            df = DeepFace.find(img_path=crop_img, db_path=img_db_path, model_name=models[2],
